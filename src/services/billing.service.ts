...
const PRICING_CONFIG = {
  HOURLY: {
    ...
    BIKE: 1.00,
    EV: 3.50,
    HANDICAP_ACCESSIBLE: 2.00,
  },
  DAY_PASS: {
    CAR: 20.00,
    BIKE: 8.00,
    EV: 25.00,
    HANDICAP_ACCESSIBLE: 15.00,
  },
  SLAB_PRICING: {
    CAR: [
      ...
      { minHours: 6, maxHours: Infinity, rate: 200 },
    ],
    BIKE: [
      { minHours: 0, maxHours: 1, rate: 20 },
      { minHours: 1, maxHours: 3, rate: 40 },
      { minHours: 3, maxHours: 6, rate: 60 },
      { minHours: 6, maxHours: Infinity, rate: 80 },
    ],
    EV: [
      { minHours: 0, maxHours: 1, rate: 70 },
      { minHours: 1, maxHours: 3, rate: 140 },
      { minHours: 3, maxHours: 6, rate: 210 },
      { minHours: 6, maxHours: Infinity, rate: 280 },
    ],
    HANDICAP_ACCESSIBLE: [
      { minHours: 0, maxHours: 1, rate: 40 },
      { minHours: 1, maxHours: 3, rate: 80 },
      { minHours: 3, maxHours: 6, rate: 120 },
      { minHours: 6, maxHours: Infinity, rate: 160 },
    ],
  },
};
